...
export const sokoOrders = [
  {
    ...
    items: [
      { productId: 'prod-001', name: 'Floral Summer Dress', price: 1500, quantity: 2, image: 'dress1' },
    ],
    subtotal: 3000,
    deliveryFee: 150,
    discount: 0,
  ...
  },
  {
    ...
    items: [
      { productId: 'prod-006', name: 'Kitenge Wrap Dress', price: 1200, quantity: 1, image: 'kitenge1' },
      { productId: 'prod-007', name: 'Ankara Fabric (2 meters)', price: 800, quantity: 3, image: 'ankara1' },
    ],
    subtotal: 3600,
    deliveryFee: 100,
    discount: 0,
